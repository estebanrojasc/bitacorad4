...
const SESSION_COOKIE = "bitacora_session";
...
/** Guarda la sesión en una cookie httpOnly de larga duración (caché). */
...
/** Devuelve la sesión actual desde la cookie, o null si no hay. */
